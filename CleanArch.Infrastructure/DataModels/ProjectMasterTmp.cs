...
public partial class ProjectMasterTmp
{
    ...
    public virtual ICollection<ProjectResourceMappingTmp> ProjectResourceMappingTmps { get; set; } = new List<ProjectResourceMappingTmp>();
}
